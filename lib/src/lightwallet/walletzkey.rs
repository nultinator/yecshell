...
pub mod tests {
  ...
  fn test_serialize() {
    ...
    // Priv Key's address is "ys1fxgluwznkzm52ux7jkf4st5znwzqay8zyz4cydnyegt2rh9uhr9458z0nk62fdsssx0cqhfrfl3"
    ...
    assert_eq!(encode_payment_address(config.hrp_sapling_address(), &wzk.zaddress), "ys1fxgluwznkzm52ux7jkf4st5znwzqay8zyz4cydnyegt2rh9uhr9458z0nk62fdsssx0cqhfrfl3".to_string());
  ...
  fn test_encrypt_decrypt_vk() {
    ...
    // Priv Key's address is "ys1va5902apnzlhdu0pw9r9q7ca8s4vnsrp2alr6xndt69jnepn2v2qrj9vg3wfcnjyks5pg6e3nk9" 
    ...
    assert_eq!(encode_payment_address(config.hrp_sapling_address(), &wzk.zaddress), "ys1va5902apnzlhdu0pw9r9q7ca8s4vnsrp2alr6xndt69jnepn2v2qrj9vg3wfcnjyks5pg6e3nk9".to_string());
