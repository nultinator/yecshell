...
impl LightClientConfig {
    ...
    pub fn create_unconnected(chain_name: String, dir: Option<String>, appdir: Option<String>, wallet_filename: Option<String>, log_filename: Option<String>) -> LightClientConfig {
        LightClientConfig {
    ...
    pub fn create(server: http::Uri,
        datadir: Option<String>,
        appdir: Option<String>,
        walletfilename: Option<String>,
        logfilename: Option<String>) -> io::Result<(LightClientConfig, u64)> {
        ...
        let lc = Runtime::new().unwrap().block_on(async move {
            ...
            let config = LightClientConfig {
                ...
                data_dir: datadir,
                app_dir: appdir,
                wallet_filename: walletfilename,
